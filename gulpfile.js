...
gulp.task('test', function() {
  ...
  gulp.src('../../../json-template-pc/archive.html')
    ...
    .pipe(gulp.dest('../../../test/pc/archives/category/postformat/'))
    .pipe(gulp.dest('../../../test/pc/archives/category/postformat/page/2'))
  gulp.src('../../../json-template-pc/post.html')
    .pipe($.concat('index.html'))
    .pipe(gulp.dest('../../../test/pc/archives/1/'))
  gulp.src('../../../json-template-pc/page.html')
    .pipe($.concat('index.html'))
    .pipe(gulp.dest('../../../test/pc/about/'))
  ...
  gulp.src('../../../json-template-mobile/archive.html')
    .pipe($.concat('index.html'))
    .pipe(gulp.dest('../../../test/mobile/archives/category/postformat/'))
    .pipe(gulp.dest('../../../test/mobile/archives/category/postformat/page/2'))
  gulp.src('../../../json-template-mobile/post.html')
    .pipe($.concat('index.html'))
    .pipe(gulp.dest('../../../test/mobile/archives/1/'))
  gulp.src('../../../json-template-mobile/page.html')
    .pipe($.concat('index.html'))
    .pipe(gulp.dest('../../../test/mobile/about/'))
});
