...
function mak_admin_theme_options_scripts() {
	...
	wp_enqueue_style( 'theme-options-style', get_stylesheet_directory_uri() . '/css/theme-options.css', array(), mak_file_time_stamp( '/css/theme-options.css' ) );

	wp_enqueue_media();
	wp_enqueue_script( 'wp-color-picker' );
	wp_enqueue_script( 'admin', get_stylesheet_directory_uri() . '/js/admin.js', array('jquery'), mak_file_time_stamp( '/js/admin.js' ), true );
	wp_enqueue_script( 'theme-options-scrip', get_stylesheet_directory_uri() . '/js/theme-options.js', array( 'jquery' ), mak_file_time_stamp( '/js/theme-options.js' ), false );
}
